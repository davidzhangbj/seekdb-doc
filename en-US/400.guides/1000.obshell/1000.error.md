...
| Gorm.NoRowAffected | %s: no row affected | This operation did not make any changes to the seekdb | Please contact the OceanBase technical support team for troubleshooting. |
...
| OB.Binary.Version.Unexpected | Unexpected observer binary version. | seekdb version is unexpected | Please contact the OceanBase technical support team for troubleshooting. |
