...
|---------------------|-------------------------|
| [0001 \~ 3999](../1380.error-code/200.0001-3999.md)            | Error messages compatible with MySQL. <br/>For more information about MySQL server error codes, see [Server Error Message Reference](https://dev.mysql.com/doc/mysql-errors/8.0/en/server-error-reference.html). <br/>For more information about MySQL client error codes, see [Client Error Message Reference](https://dev.mysql.com/doc/mysql-errors/8.0/en/client-error-reference.html). |
| [4000 \~ 4499](../1380.error-code/300.4000-4499.md)            | General error codes.   |
| [5000 \~ 5999](../1380.error-code/500.5000-5999.md)            | Error codes for SQL, WITH clauses, and factoring.     |
| [6000 \~ 6999](../1380.error-code/600.6000-6999.md)            | Error codes for transactions, MVCC, and clogs.  |
| [8000 \~ 8999](../1380.error-code/800.8000-8999.md)            | Fatal errors. When a client receives an error in this range, it must close the SQL connection.        |
| [9500 \~ 9999](../1380.error-code/1000.9500-9999.md)            | Error codes for procedural languages (PL).  |
| [22998, 30926, 38104, 38105](../1380.error-code/1100.22998-30926-38104-38105.md) | Error codes for BLOB/CLOB. |