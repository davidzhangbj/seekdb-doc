...
The `ANY` operator is supported only for array data types. For more information about the usage and examples, see [Array decision functions](../400.functions/950.array-functions/300.array-decision-functions.md).
