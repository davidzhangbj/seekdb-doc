...
In addition to the map data type, seekdb provides functions for working with map data. For more information, see [Map functions](../../../400.functions-of-mysql-mode/980.map-functions/100.map-functions-overview.md).