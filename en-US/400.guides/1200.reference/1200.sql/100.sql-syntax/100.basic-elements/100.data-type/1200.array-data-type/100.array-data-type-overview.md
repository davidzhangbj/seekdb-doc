...
In addition to providing the array data type, seekdb also provides functions for array data. For more information, see [Array functions](../../../400.functions/950.array-functions/100.array-functions-overview.md).