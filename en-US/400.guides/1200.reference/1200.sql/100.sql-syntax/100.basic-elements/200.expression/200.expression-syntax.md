...
This section lists the syntax rules that expressions must follow.

The following syntax rules define the expression syntax of seekdb:
...
For more information about operator precedence, see [Operator precedence](../../200.operator/200.operator-precedence.md).