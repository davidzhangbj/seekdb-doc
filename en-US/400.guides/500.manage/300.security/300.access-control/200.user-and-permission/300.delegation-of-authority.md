...
* Delegation of authority failed
   ...
   3. Log in to the cluster as user A, create user B, and grant the same authority as that of user A to user B. An error is returned.
...
* Delegation of authority succeeded
   ...
   3. Log in to the cluster as user A, create user B, and grant the same authority as that of user A to user B. The grant succeeds.
