...
* **Server mode**:
  ...
  * Deploy seekdb using yum install.
    ...
    For detailed deployment operations, see [Deploy seekdb using yum install](700.server-mode/600.deploy-by-systemd.md).
  
  * Deploy seekdb in a container environment.
    
    For detailed deployment operations, see [Deploy seekdb in a container environment](700.server-mode/700.deploy-by-docker.md).
  ...
  * Deploy OceanBase Desktop.
    ...
    For detailed deployment operations, see [Deploy OceanBase Desktop](700.server-mode/800.deploy-oceanbase-desktop.md).
