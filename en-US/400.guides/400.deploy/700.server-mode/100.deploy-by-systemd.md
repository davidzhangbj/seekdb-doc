...
<Tabs>
  <TabItem value="CentOS/RHEL" label="CentOS/RHEL" default>
    ...
    * Your user account has permission to run `sudo`.
    ...
    2. Import the repository GPG key:
       ...
       ```shell
       sudo rpm --import https://mirrors.aliyun.com/oceanbase/RPM-GPG-KEY-OceanBase
       ```

       If your rpm version is lower than 4.14.1, use this key instead:

       ```shell
       sudo rpm --import https://mirrors.aliyun.com/oceanbase/RPM-GPG-KEY-OceanBase-el7
       ```
    ...
    4. Download the seekdb package for your desired version from the [seekdb Download Center](https://www.oceanbase.ai/download). Copy the package to the target machine. Use the latest version when possible.

    5. In the directory containing the package, install seekdb with rpm:
    ...
    8. Verify that seekdb is running:
  ...
  <TabItem value="Debian/Ubuntu" label="Debian/Ubuntu">
    ...
    * Your user account has permission to run `sudo`.
    ...
    3. Download the seekdb package for your desired version from the [seekdb Download Center](https://www.oceanbase.ai/download). Copy the package to the target machine. Use the latest version when possible.

    4. In the directory containing the package, install seekdb with dpkg:
    ...
    5. (Optional) Edit the configuration file.
    ...
    7. Verify that seekdb is running:
  ...
  <TabItem value="macOS" label="macOS">
    ...
    * **-D**: Database name. Replace `test` with your target database if needed.
    ...
    1. Remove configuration and data:
