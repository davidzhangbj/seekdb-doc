...
* MySQL client are installed in your environment.
...
Here, connecting to seekdb through MySQL client is used as an example. The command is as follows:
...
* -A: Indicates that mysql client does not automatically obtain statistics when connecting to the database.
