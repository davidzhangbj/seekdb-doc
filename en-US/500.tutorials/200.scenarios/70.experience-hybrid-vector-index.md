...
* Ensure that you have the relevant permissions for [AI function call](../../200.develop/700.ai-function/100.ai-function-permission.md), and ensure that an embedding model has been registered in the database using the `CREATE_AI_MODEL` and `CREATE_AI_MODEL_ENDPOINT` procedures:
    :::collapse
    ```sql
...
* Learn about [vector index maintenance and monitoring](../../200.develop/600.search/300.vector-search/200.vector-index/200.dense-vector-index.md)
* Learn more about [AI function service features](../../200.develop/700.ai-function/0.ai-function-overview.md)
* Explore [hybrid search](../../200.develop/600.search/500.hybrid-search.md) to combine keyword matching and semantic understanding for more accurate and comprehensive search results.
