...
|---------|-----------|-------------|-------------|
| SeekDB | 1 | Minimum requirements: 1 CPU core, 2 GB available memory | SSD storage |

<main id="notice" type='explain'>
  <h4>Note</h4>
  <p><ul>
    <li>The log disk must be at least 3 times the memory size, and the data disk must meet the storage requirements for the target data volume.</li>
...
<main id="notice" type='explain'>
  <h4>Note</h4>
  <p>The operating system must be configured with network and software manager (yum or zypper repositories).</p>
</main>
...
* Energy performance: Set to maximum performance
  ...
  <main id="notice" type='explain'>
    <h4>Note</h4>
    <p>The method for modifying BIOS settings varies by server. For specific operations, refer to the server operation manual.</p>
  </main>
