...
1. (Optional) Modify the configuration file.
   ...
   | memory_limit | Optional | 2G | Maximum memory that SeekDB can obtain from the environment. If not configured, the `memory_limit_percentage` configuration item is used. For details about configuration items, see [memory_limit](https://en.oceanbase.com/docs/common-oceanbase-database-10000000001971998) and [memory_limit_percentage](https://en.oceanbase.com/docs/common-oceanbase-database-10000000001971796). |
...
You can uninstall SeekDB started with systemd by following these steps.
