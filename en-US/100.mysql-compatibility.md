...
SeekDB supports most features and syntax of MySQL 5.7 and 8.0. However, due to differences in product architecture or limited demand, some features are not supported. This topic will cover the following aspects of compatibility between SeekDB and native MySQL:
...
* SeekDB supports adding and dropping subpartitions in partitioned tables. MySQL does not support adding and dropping subpartitions.
  ...
  <main id="notice" type='notice'>
    <h4>Notice</h4>
    <p>Adding and dropping subpartitions is not supported for scenarios where the subpartitioning type is HASH or KEY.</p>
  </main>
