...
[MCP Server](https://github.com/oceanbase/awesome-oceanbase-mcp/tree/main/src/oceanbase_mcp_server) allows LLMs to interact with OceanBase Database and execute SQL statements. It is open-sourced on GitHub and can be quickly integrated with suitable clients.
...
2. Verify whether you can connect to the database.
   ...
   If the number of tables in the test database is displayed, it indicates that you can connect to the OceanBase database.
