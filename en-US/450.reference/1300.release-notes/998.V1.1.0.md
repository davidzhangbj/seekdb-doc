...
* RPM version: seekdb-1.1.0.0-100000132026012915
...
For a full description of `FORK TABLE`, see [Fork a table](../../200.develop/200.design-database-schema/50.fork-table.md).
...
| memory_limit | Default changed | Soft memory limit. Default changed from 0M to 2G. |
