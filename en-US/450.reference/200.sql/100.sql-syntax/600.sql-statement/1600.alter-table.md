...
| MODIFY PARTITION partition_name ADD SUBPARTITION (add_subpartition_option) | Adds a subpartition. <br/> **Note** <ul><li>You cannot add a subpartition if the subpartition type is HASH or KEY.</li><li>In seekdb, you can add a subpartition.</li></ul></p></main>|
