...
| RESTRICT \| CASCADE | Used in scenarios where tables are migrated from other databases to seekdb. <br>**Note**  This parameter is not supported in the current version. If specified, it will be parsed and ignored.</br> |
