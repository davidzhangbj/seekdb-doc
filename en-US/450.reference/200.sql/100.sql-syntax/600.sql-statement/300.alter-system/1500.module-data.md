...
|---------------|---------------------------|
| LOAD \| CHECK | Specifies whether to import or check the feature. Valid values: <ul><li>`LOAD`: specifies to import the feature.</li><li>`CHECK`: specifies to check whether the feature has been imported.</li><li>|
