...
Bitmap aggregate functions are used to aggregate numeric data into bitmap data. The current supported bitmap aggregate functions in OceanBase Database are `rb_build_agg()`, `rb_or_agg()`, and `rb_and_agg()`.
