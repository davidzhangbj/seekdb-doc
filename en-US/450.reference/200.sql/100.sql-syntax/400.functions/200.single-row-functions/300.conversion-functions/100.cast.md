...
* `type`: The data type of the target system. Supported types are as follows:
  ...
  * `JSON`: Generates a `JSON` value. For information on how to convert between the JSON data type and other data types, see [Conversion rules for JSON data type](../../../100.basic-elements/100.data-type/800.json-formatted-data-type/400.json-formatted-data-type-conversion-of-syntax-of-syntax.md).
