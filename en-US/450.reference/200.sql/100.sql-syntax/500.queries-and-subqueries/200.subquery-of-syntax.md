...
For more information about lateral derived tables, see [Lateral derived tables](../../../200.develop/300.read-and-write-data/200.read-data/200.multi-table-koin-query/600.lateral-derived-tables.md).
