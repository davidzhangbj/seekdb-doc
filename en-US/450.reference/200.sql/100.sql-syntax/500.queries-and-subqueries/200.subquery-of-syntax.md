...
For more information about lateral derived tables, see [Lateral derived tables](../../../../../en-US/200.develop/300.read-and-write-data/200.read-data/200.multi-table-join-query/600.lateral-derived-tables.md).
