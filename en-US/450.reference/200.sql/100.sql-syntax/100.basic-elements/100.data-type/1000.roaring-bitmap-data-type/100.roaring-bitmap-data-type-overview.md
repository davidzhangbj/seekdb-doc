...
In addition to the RoaringBitmap data type, SeekDB also provides functions for bitmap data. For more information, see [Functions for the RoaringBitmap data type](../../../400.functions-of-mysql-mode/940.roaring-bitmap-functions-of-mysql-mode/100.roaring-bitmap-functions-overview-of-mysql-mode.md).