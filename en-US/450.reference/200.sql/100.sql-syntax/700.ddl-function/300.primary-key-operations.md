...
In this syntax, `table_name` specifies the name of the table to which you want to add a primary key, and `column_name` specifies the column to which you want to add the primary key. For more information, see [ALTER TABLE](../600.sql-statement/1600.alter-table.md).
...
In this syntax, `table_name` specifies the name of the table to which you want to add a primary key. For more information, see [ALTER TABLE](../600.sql-statement/1600.alter-table.md).
