...
* CREATE INDEX
  ...
  * `partition_option`: specifies the options for creating index partitions.
  ...
  For more information, see [CREATE INDEX](../600.sql-statement/2200.create-index.md).
...
* CREATE TABLE
  ...
  * `index_option`: specifies the index options. You can specify multiple index options. Separate the index options with spaces.
  ...
  For more information, see [CREATE TABLE](../600.sql-statement/2600.create-table.md).
...
For more information, see [ALTER TABEL](../600.sql-statement/1600.alter-table.md).
...
* DROP INDEX
  ...
  In the statement, `index_name` specifies the name of the index to be dropped, and `table_name` specifies the name of the table to which the index belongs. For more information, see [DROP INDEX](../600.sql-statement/3700.drop-table.md).
...
* ALTER TABLE
  ...
  * `index_name`: specifies the name of the index to be dropped.
  ...
  For more information, see [ALTER TABLE](../600.sql-statement/1600.alter-table.md).
...
For more information about the syntax, see [ALTER TABEL](../600.sql-statement/1600.alter-table.md).
