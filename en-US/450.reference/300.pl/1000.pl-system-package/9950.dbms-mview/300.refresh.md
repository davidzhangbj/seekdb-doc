...
| method       | The refresh strategy of the materialized view. You can specify a default refresh strategy when you create a materialized view. Valid values: <ul><li>'f' or 'F': fast refresh.</ul></li> <ul><li>'?': force refresh.</ul></li> <ul><li>'C' or 'c': complete refresh.</ul></li> <ul><li> 'A' or 'a': complete refresh.</ul></li>  |
...
| nested | The refresh mode of the nested materialized view. Valid values: <ul><li>`FALSE`: default value, indicating that the nested materialized view is refreshed independently. </li><li>`TRUE`: indicating that the nested materialized view is cascading refreshed.|
