---
slug: /seekdb-js-hybrid-search-sample
---

# Hybrid search example

This example demonstrates the advantages of `hybridSearch()` over `query()`.

The main advantages of `hybridSearch()` are:

* Supports executing full-text search and vector similarity search simultaneously

* Allows separate filtering conditions for full-text search and vector search
...
4. Query using both `query()` and `hybridSearch()` and compare the results.
5. Print the results.
...
* For information about the APIs supported by seekdb-js, see [API Reference](../50.apis-of-seekdb-js/10.api-overview-of-seekdb-js.md).

* [Simple example](10.seekdb-js-simple-sample.md)

* [Complete example](50.seekdb-js-complete-sample.md)