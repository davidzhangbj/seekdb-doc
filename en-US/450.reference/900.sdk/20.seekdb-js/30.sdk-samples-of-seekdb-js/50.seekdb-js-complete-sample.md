---
slug: /seekdb-js-complete-sample
---

# Complete example

This example demonstrates the full capabilities of the current seekdb-js.
...
4. DQL operations, including query, get, and hybridSearch
5. Filter operators
...
* For information about the API interfaces supported by seekdb-js, see [API Reference](../50.apis-of-seekdb-js/10.api-overview-of-seekdb-js.md).

* [Simple example](10.seekdb-js-simple-sample.md)

* [Hybrid search example](100.seekdb-js-hybrid-search-sample.md)