...
You can create a custom embedding function by implementing the IEmbeddingFunction interface. The function must include the following:
...
* Set the `getConfig` method:
  ...
  * The configuration of the current `embeddingFunction` instance, used to restore this `embeddingfunction` instance. This is internal SDK logic and does not need to be used.
  * Returns: `Record<string: any>`

* Set the `buildFromConfig` static method:

  * Generates a new instance of the current `embeddingfunction` based on the required configuration. This is internal SDK logic and does not need to be used.
...
* `dimension()`: Returns the dimension of the current instance. This is internal SDK logic and does not need to be used.
...
* [Default embedding function](100.default-embedding-function-of-seekdb-js.md)
* [Use custom embedding functions](600.using-custom-embedding-functions-of-seekdb-js.md)