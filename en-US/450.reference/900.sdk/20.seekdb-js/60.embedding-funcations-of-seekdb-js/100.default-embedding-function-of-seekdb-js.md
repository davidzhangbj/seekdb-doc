...
The default vector function uses a local model (`Xenova/all-MiniLM-L6-v2`) without requiring an API key. It's ideal for quick development and testing.
...
* [Create custom embedding functions](500.create-custim-embedding-functions-of-seekdb-js.md)
