...
* You have connected to the database. For more information about connecting, see [SeekdbClient](../50.seekdbclient-of-seekdb-js.md).

* You have created a collection and inserted corresponding data. For more information about creating a collection and inserting data, see [createCollection - Create Collection](../200.collection-of-seekdb-js/100.create-collection-of-seekdb-js.md) and [add - Insert Data](../300.dml-of-seekdb-js/200.add-data-of-seekdb-js.md).
...
* If neither `queryEmbeddings` nor `queryTexts` is provided: A ValueError will be raised.
