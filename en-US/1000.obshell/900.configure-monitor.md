...
2. Set the instance name  
   ...
   <main id="notice" type='notice'>
      <h4>Notice</h4>
      <p>To set the instance name, you must add backticks (<code>`</code>) to the <code>cluster</code> parameter. </p>
   </main>
...
<main id="notice" type='explain'>
   <h4>Notes</h4>
   <p>For more information about the Prometheus alerting rules provided by OceanBase, see the <a href="https://github.com/oceanbase/obdeploy/blob/master/plugins/prometheus/2.37.1/prometheus_rules.yaml">GitHub repository</a>.</p>
</main>
...
<main id="notice" type='explain'>
   <h4>Note</h4>
   <p>Different versions of Prometheus may have different interface terms. Therefore, <b>Target</b> is provided as an example only in this case. </p>
</main>
