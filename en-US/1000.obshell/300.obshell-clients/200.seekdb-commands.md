...
<main id="notice" type='explain'>
   <h4>Note</h4>
   <p>The SeekDB commands are designed for managing a SeekDB instance. You do not need to explicitly specify the <code>--seekdb</code> option when you execute these commands. </p>
</main>
