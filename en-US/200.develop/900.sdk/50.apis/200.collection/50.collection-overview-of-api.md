...
|---|---|
| `create_collection()` | Creates a database. | [Documentation](100.create-collection-of-api.md) |
| `get_collection()` | Gets a specified database. |[Documentation](200.get-collection-of-api.md)|
...
| `list_collections()`  | Gets all databases in an instance.  |[Documentation](300.list-collection-of-api.md)|
| `count_collection()`  | Counts the number of collections in a database  |[Documentation](350.count-collection-of-api.md)|
| `delete_collection()`  | Deletes a specified database.|[Documentation](400.delete-collection-of-api.md)|