...
When creating or modifying a table, use the `CREATE TABLE/ALTER TABLE` statement to specify the tokenizer type for the full-text index by setting the parameter `WITH PARSER tokenizer_option` when creating the full-text index. For more information about the attribute parameters of other tokenizers, see [Create index](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002015436).
...
The jieba tokenization plug-in needs to be installed and compiled. For more information, see [Tokenization plug-in](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002510126).
...
* For information about how to use full-text indexes with offline DDL operations, see [Offline DDL](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002017083).
...
For more information about the `CREATE TABLE` statement, see [CREATE TABLE](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002017069).
...
* `WITH PARSER tokenizer_option`: specifies the tokenizer for the full-text index. Valid values:
  ...
  * `IK`: specifies to split the text by using the IK tokenizer for Chinese. Only the `utf-8` character set is supported. You can specify the following parameters:
   ...
   You can use the [TOKENIZE](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002017575) function to view the tokenization result of the text by using the specified tokenizer and JSON parameters.
...
For more information about the `CREATE INDEX` statement, see [CREATE INDEX](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002017039).
...
* `WITH PARSER tokenizer_option`: specifies the tokenizer for the full-text index. Valid values:
  ...
  * `IK`: specifies to split the text by IK (Chinese) method. Only the `utf-8` character set is supported. You can specify the following parameter:
   ...
   You can run the [TOKENIZE](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002017575) function to view the tokenization result of the text in the specified tokenizer and JSON format.
...
For more information about the `ALTER TABLE` statement, see [ALTER TABLE](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002017015).
...
* `WITH PARSER tokenizer_option` : specifies the tokenizer for the full-text index. Valid values:
  ...
  * `IK` : specifies the tokenizer based on IK (for Chinese). Only the `utf-8` character set is supported. You can specify the following parameter:
   ...
   You can use the [TOKENIZE](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002017575) function to view the tokenization result of the text based on the specified tokenizer and JSON parameters.
