...
For more information about Go-SQL-Driver/MySQL, see [Go-SQL-Driver/MySQL](https://github.com/go-sql-driver/mysql#installation) in the OceanBase Database open-source community.