...
This topic provides a JDBC configuration example. JDBC is an interface for Java database connections. OceanBase Database provides a JDBC driver to support Java applications in connecting to OceanBase Database. You can download the JDBC driver from [OceanBase JDBC Driver](https://en.oceanbase.com/softwarecenter-enterprise).
