...
For more information about tables in SeekDB, see [Table overview](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002016766).
...
* You have connected to seekdb. For more information about how to connect to a database, see [Overview](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002013253).
...
You can run the [CREATE TABLE](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002017069) statement to create a table.
...
* We recommend that you use meaningful names for tables. We do not recommend that you use names such as `t1` or `table1`. For more information about table naming, see [Table naming](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002013334).
...
* Determine whether to define a primary key column for the table based on the requirements of [Primary key columns](#define-primary-key-column).

* Determine whether to add other constraints to the column based on the requirements of [Other constraints](#define-other-column-constraints).
...
To specify a column as a primary key column, add the `PRIMARY KEY` keyword after the column definition. If you want to define a primary key constraint on multiple columns, add the definition of the primary key constraint after the list of all columns in the [CREATE TABLE](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002017069) statement.
...
For more information about primary key constraints, see [Primary key constraints](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002017305).
...
After you define primary key columns, you can delete the primary key. For more information about primary key constraints, see [Define the constraint type of a column](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002015447).
...
* FOREIGN KEY constraint: specifies that the values of the constrained column must be values of the primary key column of another table.
  ...
  By default, seekdb enables the FOREIGN KEY constraint check. The FOREIGN KEY constraint check is controlled by the tenant variable `foreign_key_checks`. For more information about the `foreign_key_checks` variable, see [foreign_key_checks](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002016028).
...
For more information about how to define other column constraints, see [Define column constraints](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002015447).
...
An auto-increment column has three important attributes: the auto-increment start value, the auto-increment step, and the auto-increment cache size. These attributes are controlled by the three tenant variables `auto_increment_cache_size`, `auto_increment_increment`, and `auto_increment_offset`.
...
For more information about auto-increment columns, see [Define an auto-increment column](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002015440).
...
In seekdb, the maximum number of partitions supported for a single table is specified by the [max_partition_num](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002015551) parameter. The default value is 8192.
...
For more information about partitions, see [Overview](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002016759).
...
* After you create a table, you can use the `INSERT` statement to insert data into the table. For more information about how to insert data, see [Insert data](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002013243).
