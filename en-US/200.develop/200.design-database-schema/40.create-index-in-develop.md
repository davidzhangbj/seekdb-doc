...
This topic describes how to create an index by using the `CREATE INDEX` statement. Multi-value indexes can be created only when you create a table. For more information about other ways to create an index, see [CREATE TABLE](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002017069) or [ALTER TABLE](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002017015).
...
For more information about indexes in SeekDB, see [Introduction](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002016787).
...
* We recommend that you use a concise name to describe the columns and purpose of the index, for example, `idx_customer_name`. For more information about naming conventions, see [Overview of object naming conventions](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002013337).
...
* We recommend that you issue the CREATE INDEX statement in parallel. The number of concurrent CREATE INDEX statements must not exceed the number of CPU cores specified in the tenant's unit specification. For example, if the tenant's unit specification is 4 CPU cores (4C), we recommend that you create no more than 4 indexes in parallel.
...
You can run the [CREATE INDEX](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002017039) statement to create an index.
...
In seekdb, expressions of some system functions are not supported for function indexes. For more information, see [List of system functions supported for function indexes](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002015437) and [List of system functions not supported for function indexes](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002015435).
...
After you create an index, you may need to optimize query performance. For more information about SQL tuning, see [Overview of SQL tuning](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002013770).