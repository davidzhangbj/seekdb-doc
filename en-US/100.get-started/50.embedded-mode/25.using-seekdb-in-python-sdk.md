...
* Client/Server mode
    ...
    For information about using seekdb in client/server mode, see [Experience seekdb in client/server mode using SQL](../100.client-server-mode/10.deploy-seekdb-testing-environment.md).
...
When you install pyseekdb, it also installs embedded-mode seekdb, allowing you to directly connect to embedded seekdb to perform operations like creating a database.
...
Use the `Client` to connect to the `hybrid_search_test` database and create a collection.

:::tip

* For more information about the Client, see [Client](../../200.develop/900.sdk/50.apis/50.client.md).
