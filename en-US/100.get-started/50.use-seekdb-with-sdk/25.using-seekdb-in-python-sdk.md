...
:::tip
In addition to Linux, you can also use pyseekdb in macOS and Windows. However, for Windows, only server mode of seekdb is supported currently. For more information about how to use pyseekdb in macOS and Windows, see [Get started with pyseekdb](../../450.reference/900.sdk/10.pyseekdb-sdk/10.pyseekdb-sdk-get-started.md).
:::
