...
* For more information about the `Admin Client`, see [Admin Client](../../450.reference/900.sdk/50.apis/100.admin-client.md).

* For more information about creating a database, see [create_database - Create a database](../../450.reference/900.sdk/50.apis/110.database/200.create-database-of-api.md).
...
* For more information about `Client`, see [Client](../../450.reference/900.sdk/50.apis/50.client.md).
* For more information about creating a collection, see [create_collection - Create a Collection](../../450.reference/900.sdk/50.apis/200.collection/100.create-collection-of-api.md).
...
For more information about inserting data, see [add - Insert data](../../450.reference/900.sdk/50.apis/300.dml/200.add-data-of-api.md).
...
For more information about hybrid search, see [hybrid_search - Hybrid search](../../450.reference/900.sdk/50.apis/400.dql/400.hybrid-search-of-api.md).
...
* For more information about deleting a collection, see [delete_collection - Delete a Collection](../../450.reference/900.sdk/50.apis/200.collection/400.delete-collection-of-api.md).

* For more information about deleting a database, see [delete_database - Delete a database](../../450.reference/900.sdk/50.apis/110.database/500.delete-database-of-api.md).
...
* For more pyseekdb usage examples, see:
  ...
  * [Hybrid search example](../../450.reference/900.sdk/10.pyseekdb-sdk/50.sdk-samples/100.pyseekdb-hybrid-search-sample.md): Demonstrates the usage of seekdb hybrid search, and compares it with vector retrieval capabilities.
