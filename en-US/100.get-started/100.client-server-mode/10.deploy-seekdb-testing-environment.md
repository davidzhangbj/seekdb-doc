...
# Quickly deploy seekdb in server mode

seekdb provides embedded mode and server mode. You can choose the appropriate deployment mode based on your business scenario. This topic introduces how to quickly deploy seekdb in server mode.

:::info
For information about using seekdb in embedded mode, see <a href="../50.embedded-mode/25.using-seekdb-in-python-sdk.md">Experience embedded seekdb</a>.
:::
...
:::info
For more detailed and comprehensive deployment methods for seekdb, see <a href="../../400.guides/400.deploy/50.deploy-overview.md">Deployment overview</a>.
:::
