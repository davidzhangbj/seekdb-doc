...
:::info
For more information about how to use seekdb with SDK, see [Experience embedded seekdb with Python SDK](../50.embedded-mode/25.using-seekdb-in-python-sdk.md).
:::
