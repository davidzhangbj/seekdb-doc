...
1. Call the `AI_COMPLETE` function.
    ...
    ```sql
    SELECT AI_COMPLETE("ob_complete","You are a professional translator. Please translate the following text into English: {{你好世界.}}, and only output the translated result.") as ans;
    ```
