# Privileges for the AI function service

<!-- 待优化：AI 函数服务，描述统一、示例国际化 -->

This topic describes the privileges required for using the AI function service, specifically the `AI MODEL` and `ACCESS AI MODEL` privileges, which are used for managing AI models and invoking AI functions, respectively.

## AI MODEL

Privileges related to `AI MODEL` are used for managing AI models. These include three specific privileges: `CREATE AI MODEL`, `ALTER AI MODEL`, and `DROP AI MODEL`.
...
The `ACCESS AI MODEL` privilege is used for calling AI functions, including `AI_COMPLETE`, `AI_EMBED`, and `AI_RERANK`.
