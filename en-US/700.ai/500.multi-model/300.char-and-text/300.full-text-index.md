...
* With the default setting `n=2`, this tokenizer outputs all consecutive 2-character tokens, including overlapping ones.
...
<main id="notice" type='explain'>
  <h4>Note</h4>
  <p>When using the ngram2 tokenizer, be aware of its high memory consumption. For example, setting a large range for <code>min_ngram_size</code> and <code>max_ngram_size</code> parameters will generate a large number of token combinations, which may lead to excessive resource consumption.</p>
</main>
...
* This tokenizer outputs all consecutive subsequences with lengths between 4-6 characters, with overlapping tokens allowed.
