...
* **`products` table**: A basic product information table used to demonstrate scalar search. It contains product ID, name, description, brand, category, tags, price, stock quantity, release date, on-sale status, and a vector field `vec`.
  :::collapse
...
Some use cases for scalar search are as follows:
...
### Range search for scalars

Some use cases for scalar range search are as follows:
