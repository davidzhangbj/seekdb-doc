...
This topic describes how to integrate the [vector search feature](../100.vector-search/100.vector-search-overview/100.vector-search-intro.md) of SeekDB with [Tongyi Qianwen (Qwen)](https://www.alibabacloud.com/en/solutions/generative-ai/qwen?_p_lc=1), and [LangChain](https://python.langchain.com/) for Document Question Answering (DQA).

## Prerequisites

* You have deployed SeekDB.
* You have access to a MySQL database and account with read and write privileges.
...
Download the sample data and split it into chunks of approximately 1000 characters using `CharacterTextSplitter`.
