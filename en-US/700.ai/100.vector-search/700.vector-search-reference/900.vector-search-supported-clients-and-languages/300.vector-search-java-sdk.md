...
<main id="notice" type='notice'>
  <h4>Notice</h4>
  <p>For more complex types, constraints, and other functionalities, you can use SeekDB JDBC's interface directly instead of using obvec_jdbc. </p>
</main>
...
<main id="notice" type='notice'>
  <h4>Notice</h4>
  <p>obvec_jdbc supports only the creation of vector indexes. To create other indexes, use SeekDB JDBC. </p>
</main>
