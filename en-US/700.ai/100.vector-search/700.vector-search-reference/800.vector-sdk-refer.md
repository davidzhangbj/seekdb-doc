...
For more information about pyobvector's APIs, see [pyobvector Python SDK API reference](../700.ai/100.vector-search/700.vector-search-reference/900.vector-search-supported-clients-and-languages/200.vector-pyobvector.md).
...
| JSON | JSON | For differences and similarities in JSON operations, see [pyobvector Python SDK API reference](../700.ai/100.vector-search/700.vector-search-reference/900.vector-search-supported-clients-and-languages/200.vector-pyobvector.md). |
...
* Segments are similar to [MemTable](../../700.reference/100.oceanbase-database-concepts/900.storage-architecture/200.data-storage/200.MEMTable.md) + [SSTable](../../700.reference/100.oceanbase-database-concepts/900.storage-architecture/200.data-storage/300.SSTable.md).
...
1. Milvus search():
    ...
    * filter: string expression. For usage examples, see: https://milvus.io/docs/boolean.md#Usage. It is generally similar to SQL's `WHERE` expression.
