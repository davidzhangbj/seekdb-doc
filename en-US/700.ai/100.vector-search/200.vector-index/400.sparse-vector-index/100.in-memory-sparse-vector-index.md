...
For detailed requirements, see [Dense vector index](../200.vector-index.md). Here, only the special requirements for sparse vector indexes are described:
...
* For monitoring and maintenance of dense vector indexes, see [Vector index monitoring/maintenance](../200.vector-index.md).
* For index memory estimation and actual usage query of vector indexes, see [Index memory estimation and actual usage query](../200.vector-index.md).
