...
Welcome to the official documentation repository for seekdb, the AI-native search database that unifies relational, vector, text, JSON and GIS in a single engine to enable hybrid search and in‑database AI workflows.

This repository hosts the full set of seekdb documentation, including product overview, developer guides, tutorials, and integration references.
