...
* 查询 `INFORMATION_SCHEMA` 的 `TRIGGERS` 表。详细信息，请参见 [INFORMATION_SCHEMA TRIGGERS](../800.information-schema-dictionary-view/300.information-schema-triggers.md)。

* 使用 `SHOW CREATE TRIGGER` 语句。详细信息，请参见 [SHOW CREATE TRIGGER](../700.pl-database-management-statements/300.show-create-trigger.md)。

* 使用 `SHOW TRIGGERS` 语句。详细信息，请参见 [SHOW TRIGGERS](../700.pl-database-management-statements/600.show-triggers.md)。
