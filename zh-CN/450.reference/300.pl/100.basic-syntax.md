...
`DECLARE` 语句用于定义程序的局部变量、异常处理和游标，详细信息请分别参见 [存储程序的变量](200.storage-object-mysql/200.variables-in-stored-programs-mysql.md)、[异常处理](900.pl-exception-handling-statement/100.exception-handling-statement.md)和[游标](300.cursor/100.overview-of-cursors.md)。
...
有关块内异常处理程序的声明，请参见 [DECLARE ... HANDLER](900.pl-exception-handling-statement/300.declare-handler.md)。
