...
`DECLARE` 语句用于定义程序的局部变量、异常处理和游标，详细信息请分别参见 [存储程序的变量](200.storage-object/200.variables-in-stored-programs.md)、[异常处理](900.pl-exception-handling-statement/100.exception-handling-statement.md)和[游标](300.cursor/100.overview-of-cursors.md)。
