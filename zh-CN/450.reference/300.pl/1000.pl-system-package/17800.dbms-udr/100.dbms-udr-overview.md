...
| **子程序** | **描述** |
| --- | --- |
| [CREATE_RULE](../17800.dbms-udr/200.create-rule.md) | 创建一条自定义改写规则。 |
| [DISABLE_RULE](../17800.dbms-udr/300.disable-rule.md) | 关闭一条自定义改写规则。 |
| [ENABLE_RULE](../17800.dbms-udr/400.enable-rule.md) | 开启一条自定义改写规则。 |
| [REMOVE_RULE](../17800.dbms-udr/500.remove-rule.md) | 删除一条自定义改写规则。 |
