...
| API 接口  | 描述      |相关文档链接|
|---|---|---|
| `createDatabase` | 创建一个新数据库。|[文档](110.database/200.create-database-of-api.md)|
| `getDatabase`    | 查询指定的数据库。|[文档](110.database/300.get-database-of-api.md)|
| `deleteDatabase` | 删除指定的数据。 |[文档](110.database/400.list-database-of-api.md)|
| `listDatabases` |列出所有数据库。|[文档](110.database/500.delete-database-of-api.md)|
