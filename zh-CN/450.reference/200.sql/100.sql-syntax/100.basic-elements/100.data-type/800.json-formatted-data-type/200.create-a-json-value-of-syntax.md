...
1. 启用半结构化编码
   ...
   如果启用半结构化编码功能，请务必保证配置项 <a href="../../../../../../800.configuration-items-and-system-variables/100.system-configuration-items/300.cluster-level-configuration-items/14400.micro_block_merge_verify_level.md">micro_block_merge_verify_level</a> 为默认配置 `2`，切勿关闭微块合并校验。
