...
* `data_type`：指定数据类型，当前支持 seekdb下除 `ENUM` 和 `SET` 之外的所有数据类型。
...
[JSON 数据类型](../../100.basic-elements/100.data-type/800.json-formatted-data-type/100.json-formatted-data-types.md)