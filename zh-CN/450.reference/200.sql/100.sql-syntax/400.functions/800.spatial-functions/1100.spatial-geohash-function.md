...
* 有关 `ST_GEOMFROMTEXT` 的信息，参见 [创建几何值函数](150.create-a-geometry-function.md)。

* 有关 `POLYGON` 的信息，参见 [空间数据格式](../../100.basic-elements/100.data-type/900.spatial-data-type/500.spatial-data-format-of-syntax-of-syntax.md)。
