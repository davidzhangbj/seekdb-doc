...
* CREATE INDEX
  ...
  * `partition_option`：指定创建索引分区的选项。
  ...
  详细语法介绍可参见 [CREATE INDEX](../600.sql-statement/2200.create-index.md)。
...
* CREATE TABLE
  ...
  * `index_option`：指定索引选项，指定多个 `index_option` 时使用空格隔开。
  ...
  详细语法介绍可参见 [CREATE TABLE](../600.sql-statement/2600.create-table.md)。
...
详细的语法介绍可参见 [ALTER TABEL](../600.sql-statement/1600.alter-table.md)。
...
* DROP INDEX
  ...
  其中，`index_name` 指定待删除的索引的索引名；`table_name` 指定待删除索引的表的表名。详细的语法介绍可参见 [DROP INDEX](../600.sql-statement/3700.drop-table.md)。
...
* ALTER TABLE
  ...
  * `index_name` 指定待删除的索引的索引名。
  ...
  详细的语法介绍可参见 [ALTER TABLE](../600.sql-statement/1600.alter-table.md)。
...
* [索引简介](../../../../100.oceanbase-database-concepts/400.database-objects/200.database-objects/300.index-of-oracle-mode/100.index-overview.md)

* [创建和管理索引](../../../../300.database-object-management/100.manage-object/500.manage-indexes/200.create-an-index.md)