...
| overwrite_table_insert  | 用于将查询结果替换表或分区中的现有数据，有关使用 `INSERT OVERWRITE SELECT` 语句的详细信息，参见 [插入数据](../../../../../200.develop/100.application-development/400.write-data/100.insert-data-in-develop.md) 中的 **使用 INSERT OVERWRITE SELECT 语句插入数据** 章节。|
...
* [插入数据](../../../../../200.develop/100.application-development/400.write-data/100.insert-data-in-develop.md)
