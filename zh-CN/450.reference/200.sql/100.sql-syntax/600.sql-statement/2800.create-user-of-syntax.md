...
执行 `CREATE USER` 语句创建用户需要当前用户拥有全局的 CREATE USER 权限。有关 seekdb 权限的详细介绍，参见 [seekdb 的权限分类](../../../../../../../400.guides/500.manage/300.security/300.access-control/200.user-and-permission/100.permission-classification.md)。
...
* 使用创建的用户连接 seekdb 的操作可参见 [连接 seekdb ](../../../../../200.develop/100.application-development/100.connect-to-oceanbase-database/100.connection-methods-overview.md) 章节。