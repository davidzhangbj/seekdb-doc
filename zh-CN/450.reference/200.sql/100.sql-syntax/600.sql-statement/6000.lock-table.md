...
* 使用 `LOCK TABLES` 语句前，需要打开如下配置项：
  ...
  上述配置项详细介绍，参见 [enable_lock_priority](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002973869)。
...
执行 `LOCK TABLES` 语句，需要当前用户至少拥有对应对象的 `LOCK TABLES` 权限。有关 seekdb 权限的详细介绍，参见 [seekdb 的权限分类](../../../../../../../400.guides/500.manage/300.security/300.access-control/200.user-and-permission/100.permission-classification.md)。
