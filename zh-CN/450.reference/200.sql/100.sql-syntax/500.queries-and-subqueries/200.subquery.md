...
对于 `HAVING` 或 `ORDER BY` 子句中的子查询，seekdb 同样会在外部 `SELECT` 列表中查找列名。
...
更多有关横向派生表的使用信息，请参见 [横向派生表](../../../../../300.develop/100.application-development/500.read-data/200.multi-table-join-query/600.lateral-derived-tables-of-mysql-develop.md)。
