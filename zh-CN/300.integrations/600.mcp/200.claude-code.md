...
* Claude Code 安装：
  ...
  1. 使用 Visual Studio Code 安装 Claude Code 插件，插件名称为 `Claude Code for VS Code`。
     ...
     ![1](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/SeekDB/integrations/developer-tools/claude-code/1.pngg)
  ...
  2. Visual Studio Code 配置 Claude Code。
      ...
      ```shell
      export ANTHROPIC_BASE_URL=https://api.aicanapi.com
