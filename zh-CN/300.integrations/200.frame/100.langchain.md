...
本教程结合通义千问 API 演示如何将 seekdb 中的 [向量检索功能](../../200.develop/100.vector-search/100.vector-search-overview/100.vector-search-intro.md)、[通义千问](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000001579715) 与 [LangChain](https://python.langchain.com/) 集成实现文档问答。
...
更多连接串的信息，请参见 [通过 OBClient 连接 OceanBase](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000003977064)。
