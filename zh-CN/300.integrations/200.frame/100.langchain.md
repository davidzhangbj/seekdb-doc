...
本教程结合通义千问 API 演示如何将 seekdb 中的 [向量搜索概述](../../200.develop/100.vector-search/100.vector-search-overview/100.vector-search-intro.md)、[通义千问](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000001579715) 与 [LangChain](https://python.langchain.com/) 集成实现文档问答。
...
* `$database_name`：需要访问的数据库名称。
    ...
    <main id="notice" type='notice'>
        <h4>注意</h4>
        <p>连接数据库的用户需要拥有该数据库的 <code>CREATE</code>、<code>INSERT</code>、<code>DROP</code> 和 <code>SELECT</code> 权限。更多有关用户权限的信息，请参见 <a href="https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000003980139">MySQL 模式下的权限分类</a>。</p>
    </main>
