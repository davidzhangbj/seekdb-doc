...
* 联系管理员获取相应的数据库连接串，然后执行以下命令连接到数据库：
    ...
    ```
* 确保你已拥有 [AI 函数服务](../../200.develop/300.ai-function/200.ai-function.md)相关权限。每个示例前都会提供完整的模型和端点注册信息，您可以直接复制使用。
...
-- 直接构建字符串数组格式的文档列表
SET @candidate_docs = '["seekdb 是一个强大的数据库系统，支持向量检索和 AI 函数。", "向量搜索可以用于语义搜索，找到相似的内容。"]';
...
* 通过视图查看和监控 AI 模型信息及调用情况在 [AI 函数服务使用及示例-AI 模型调用监控](../../200.develop/300.ai-function/200.ai-function.md)小节
* 了解 [向量搜索](../../200.develop/100.vector-search/100.vector-search-overview/100.vector-search-intro.md)
