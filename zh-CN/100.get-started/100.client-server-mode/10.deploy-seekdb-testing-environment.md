...
:::info
有关嵌入式模式使用方式，参见 [体验嵌入式 seekdb](../50.embedded-mode/25.using-seekdb-in-python-sdk.md)</a>。
:::
...
:::info
关于 seekdb 更详细和更全面的部署方式，参见 [部署概述](../../400.guides/400.deploy/50.deploy-overview.md)</a>。
:::
