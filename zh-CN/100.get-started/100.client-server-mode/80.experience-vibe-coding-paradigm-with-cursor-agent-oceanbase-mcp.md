...
* [体验 Cursor Agent + OceanBase MCP 的 Vibe Coding 新范式](80.experience-vibe-coding-paradigm-with-cursor-agent-oceanbase-mcp.md)
...
除了使用 SQL 进行操作之外，也支持通过 seekdb 提供的 Python SDK（pyseekdb）进行操作，使用方法参见 [体验嵌入式 seekdb]（../50.embedded-mode/25.using-seekdb-in-python-sdk.md）和 [pyseekdb 概述]()。