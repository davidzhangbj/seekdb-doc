...
* 关于 Admin Client 的详细介绍，参见 [Admin Client](../../450.reference/900.sdk/50.apis/100.admin-client.md)。

* 关于创建数据库的详细介绍，参见 [create_database - 创建数据库](../../450.reference/900.sdk/50.apis/110.database/200.create-database-of-api.md)。
...
* 关于 Client 的详细介绍，参见 [Client](../../450.reference/900.sdk/50.apis/50.client.md)。
* 关于创建 collection 的详细介绍，参见 [create_collection - 创建 Collection](../../450.reference/900.sdk/50.apis/200.collection/100.create-collection-of-api.md)。
...
关于插入数据的详细介绍，参见 [add - 插入数据](../../450.reference/900.sdk/50.apis/300.dml/200.add-data-of-api.md)。
...
关于混合检索的详细介绍，参见 [hybrid_search - 混合搜索](../../450.reference/900.sdk/50.apis/400.dql/400.hybrid-search-of-api.md)。
...
* 关于删除 collection 的详细介绍，参见 [delete_collection - 删除 Collection](../../450.reference/900.sdk/50.apis/200.collection/400.delete-collection-of-api.md)。

* 关于删除数据库的详细介绍，参见 [delete_database - 删除数据库](../../450.reference/900.sdk/50.apis/110.database/500.delete-database-of-api.md)。
...
* 有关更多 pyseekdb 的使用示例参见：
  ...
  * [混合搜索示例](../../450.reference/900.sdk/10.pyseekdb-sdk/50.sdk-samples/100.pyseekdb-hybrid-search-sample.md)：演示了 seekdb 混合搜索的使用，同时与向量检索的能力对比。
