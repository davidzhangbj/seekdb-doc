...
* 服务器模式
    ...
    有关服务器模式的使用方式，参见 [通过 SQL 快速体验服务器模式 seekdb](../100.client-server-mode/10.deploy-seekdb-testing-environment.md)。
...
# ==================== Step 4: hybrid search the Collection ====================
# Perform hybrid search
hybrid_result1 = collection.hybrid_search(
    query={"where_document": {"$contains": "machine learning"}, "n_results": 10},
    knn={"query_texts": ["AI research"], "n_results": 10},
...
* 除了 Python SDK 之外，seekdb 也支持通过 SQL 进行操作，有关 SQL 的使用方法，参见 [通过 SQL 快速体验服务器模式 seekdb](../100.client-server-mode/10.deploy-seekdb-testing-environment.md)。
