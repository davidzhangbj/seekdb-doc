...
:::tip
除了 Linux 系统之外，也支持在 macOS 和 Windows 系统下使用 pyseekdb，但是当前仅支持使用服务器模式的 seekdb。有关 macOS 和 Windows 系统下的使用介绍，参见 [pyseekdb 快速开始](../../200.develop/900.sdk/10.pyseekdb-sdk/10.pyseekdb-sdk-get-started.md)。
:::
...
* 关于 Admin Client 的详细介绍，参见 [Admin Client](../../200.develop/900.sdk/50.apis/100.admin-client.md)。

* 关于创建数据库的详细介绍，参见 [create_database - 创建数据库](../../200.develop/900.sdk/50.apis/110.database/200.create-database-of-api.md)。
...
* 关于 Client 的详细介绍，参见 [Client](../../200.develop/900.sdk/50.apis/50.client.md)。
* 关于创建 collection 的详细介绍，参见 [create_collection - 创建 Collection](../../200.develop/900.sdk/50.apis/200.collection/100.create-collection-of-api.md)。
...
使用 `add` 方法往 collection 中插入数据。

:::tip

关于插入数据的详细介绍，参见 [add - 插入数据](../../200.develop/900.sdk/50.apis/300.DML/200.add-data-of-api.md)。
...
使用 `hybrid_search` 方法进行混合搜索查询。

:::tip

关于混合检索的详细介绍，参见 [hybrid_search - 混合搜索](../../200.develop/900.sdk/50.apis/400.dql/400.hybrid-search-of-api.md)。
...
使用 `delete_collection` 方法删除 collection 以及使用 `delete_database` 方法删除数据库。

:::tip

* 关于删除 collection 的详细介绍，参见 [delete_collection - 删除 Collection](../../200.develop/900.sdk/50.apis/200.collection/400.delete-collection-of-api.md)。

* 关于删除数据库的详细介绍，参见 [delete_database - 删除数据库](../../200.develop/900.sdk/50.apis/110.database/500.delete-database-of-api.md)。
...
print(f"\nDeleted database '{database_name}'")
```
...
collection_name = "hybrid_search_demo"
client = pyseekdb.Client(path="./seekdb.db",database=database_name)
...
# ==================== Step 6: 清理环境，删除 collection 和 database ====================
client.delete_collection(collection_name)
print(f"\nDeleted collection '{collection_name}'")
...
* 有关更多 pyseekdb 的使用示例参见：
  ...
  * [Simple 示例](../../200.develop/900.sdk/10.pyseekdb-sdk/50.sdk-samples/10.pyseekdb-simple-sample.md)：演示了当前 pyseekdb 支持的基础操作。

  * [Complete 示例](../../200.deve lop/900.sdk/10.pyseekdb-sdk/50.sdk-samples/50.pyseekdb-complete-sample.md)：演示了当前 pyseekdb 支持的全量能力。

  * [混合搜索示例](../../200.develop/900.sdk/10.pyseekdb-sdk/50.sdk-samples/100.pyseekdb-hybrid-search-sample.md)：演示了 seekdb 混合搜索的使用，同时与向量检索的能力对比。
