...
有关 seekdb MCP Server 的更多信息，可参见 [seekdb MCP Server](https://www.oceanbase.ai/docs/zh-CN/seekdb-mcp-server)。
...
* 目前嵌入式模式 seekdb 支持 Linux 平台（glibc >= 2.28，x86_64 / aarch64 架构）与 macOS 15 及以上版本，请确保您使用的系统满足要求。
* 您已安装 Cursor 或其他支持 MCP 协议的工具（如 Windsurf、Qoder）。
* 您已安装 Python 环境（版本 3.11～3.13）。
