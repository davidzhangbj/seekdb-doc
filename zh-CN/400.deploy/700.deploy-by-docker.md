...
<main id="notice" type='notice'>
  <h4>注意</h4>
  <ul><li>在 MacOS 和 Intel 芯片上运行此镜像时，如果 Docker 版本高于 4.9.0，存在已知问题。您可以在此处下载所需版本的 <a href="https://desktop.docker.com/mac/main/amd64/81317/Docker.dmg?_gl=17jelfd_gcl_auOTk5Nzk0MDUwLjE3MTE4ODMyNzM._gaNDQyMjE1MDE5LjE3MTE4ODMyNzQ._ga_XJWPQMJYHQ*MTcxOTIxOTEwMy4xMS4xLjE3MTkyMjEwMTAuNjAuMC4w">Docker</a>。</li>
  <li>此镜像仅用于测试；请勿在生产环境中使用。</li></ul>
</main>
...
<main id="notice" type='explain'>
  ...
  <li>
  <p>上述命令默认拉取最新版本，可根据实际需求在 <a href="https://hub.docker.com/r/oceanbase/seekdb">dockerhub</a>、<a href="https://quay.io/repository/oceanbase/seekdb">quay.io</a> 或 <a href="https://ghcr.io/oceanbase/seekdb">ghcr.io</a>中选择版本。</p>
  </li>
  </ul>
</main>
...
<main id="notice" type='notice'>
  <h4>注意</h4>
  <p>请勿在 SQL 脚本中更改 root 用户的密码。如果您想更改 root 用户的密码，请使用环境变量 <code>ROOT_PASSWORD</code>，示例如下：<code>docker run -d -p 2881:2881 -e ROOT_PASSWORD="******" oceanbase/seekdb</code>。</p>
</main>
...
2. 启动 SeekDB 。
  ...
  <main id="notice" type='notice'>
    <h4>注意</h4>
    <p>如果您决定使用配置文件，请不要指定与资源相关的环境变量。</p>
  </main>
