...
2. 安装应用
   ...
   5. 安装完成后，单击 **完成**，将会自动运行桌面版 SeekDB 。
...
3. 启动桌面版 SeekDB 
   ...
   安装完成后，打开桌面版，会出现一个登录 OBShell 的登录界面。登录密码默认为空，直接点击 **登录** 即可进入。
   ...
   进入 OBShell 页面后，实例自动启动，您可以在该页面查看实例的信息以及进行实例管理。
...
SeekDB 启动成功后，您可以通过黑屏界面连接 SeekDB，连接串示例如下：
