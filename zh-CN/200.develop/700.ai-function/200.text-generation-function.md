...
* 在使用文本生成类 AI 函数之前，需要确保你已注册好 AI 模型及端点信息。详细信息请参见 [AI 模型管理](../600.llm/100.model-service-overview.md)。
...
* [使用 AI_EMBED 函数](../600.vector-embedding/200.ai-embed-function.md)
* [重排序搜索](../700.search/600.ai-rerank.md)
