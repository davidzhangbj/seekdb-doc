...
要调用 AI 函数，需要确保用户已拥有 `AI MODEL` 相关权限。因为注册 AI 模型和端点依赖 `AI MODEL` 相关权限，注册了相应 AI 模型和端点后，才能调用 AI 函数。`AI MODEL` 相关权限的说明和使用请参见 [模型权限管理](../600.llm/200.model-service-permission.md)，模型注册与管理方式请参见 [模型注册与管理](../600.llm/300.model-register-and-manage.md)。
