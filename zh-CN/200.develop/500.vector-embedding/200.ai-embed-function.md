...
在使用 `AI_EMBED` 函数等 AI 函数服务之前，需要确保你已拥有相关权限。详细权限请参见 [AI 函数服务权限](../100.ai-function-permission.md)。
...
* [AI 函数服务概述](../660.llm/100.ai-function-overview.md)
* [AI 函数服务权限配置](../600.llm/200.ai-function-permission.md)
