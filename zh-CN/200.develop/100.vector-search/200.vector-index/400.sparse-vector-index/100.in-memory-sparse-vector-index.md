...
详细要求请参见[稠密向量索引](../200.dense-vector-index.md)。这里仅介绍稀疏向量索引的特殊要求：
...
* 关于稠密向量索引的监控与维护，请参见[稠密向量索引](../200.dense-vector-index.md)。
* 关于向量索引的内存估算与实际占用查询，请参见[稠密向量索引](../200.dense-vector-index.md)。
