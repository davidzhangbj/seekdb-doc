...
* 您已连接 seekdb。
* 您已拥有 `SELECT` 权限。更多有关查看当前用户权限的相关操作信息，请参见 [查看用户权限](../../400.guides/500.manage/300.security/300.access-control/200.user-and-permission/400.view-user-permissions.md)。如果不具备该权限，请联系管理员为您授权，用户授权的相关操作请参见 [直接授予权限](../../400.guides/500.manage/300.security/300.access-control/200.user-and-permission/200.direct-authority.md)。

## 语法

请使用 [SELECT](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002017573) 语句进行查询数据。
...
更多有关查询条件运算符的详细信息，请参见 [比较运算符](../../450.reference/200.sql/100.sql-syntax/200.operator/500.comparison-operators.md)。
...
有关使用聚合函数查询的详细信息，请参见 [查询中使用聚合函数](300.use-operators-and-functions-in-query/700.use-aggregate-functions-in-queries.md)。
...
* 更多有关 `SELECT` 语法的信息，请参见 [SELECT](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002017573)。

* 更多有关查询条件运算符的详细信息，请参见 [比较运算符](../../450.reference/200.sql/100.sql-syntax/200.operator/500.comparison-operators.md)。

* 更多有关子查询的详细信息，请参见 [子查询](200.multi-table-join-query/500.subquery.md)。

* 更多有查询语句优化的详细信息，请参见 [查询改写概述](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002016236)。
