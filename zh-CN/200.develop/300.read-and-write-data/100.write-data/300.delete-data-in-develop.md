...
通常使用 [DELETE](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002017032) 语句来删除表中的部分数据或全部数据。

:::info

除了 `DELETE` 语句外，`REPLACE INTO` 语句也可能会删除数据，`REPLACE INTO` 语句相关的操作及示例请参见 [替换数据](400.replace-data-in-develop.md)。
...
更多 `TRUNCATE TABLE` 语句的使用及说明请参见 [TRUNCATE TABLE](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002017016)。

## 相关文档

* [插入数据](100.insert-data-in-develop.md)

* [更新数据](200.update-data-in-develop.md)

* [替换数据](300.delete-data-in-develop.md)
