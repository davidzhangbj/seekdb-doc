...
* 请确认您已连接到 seekdb，连接数据库的操作请参见 [连接方式概述](../100.connect-to-oceanbase-database-of-mysql-mode/100.connection-methods-overview-of-mysql-mode.md)。
...
通常使用 [REPLACE INTO](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002017054) 语句替换表中的一条或多条记录。
