...
[点击下载 java-oceanbase-springdatajpa 示例工程](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/observer/V4.3.0/%E5%BA%94%E7%94%A8%E5%BC%80%E5%8F%91demo/springDateJpa.zip)
...
2. 根据已部署的 seekdb 填写下面 URL 的对应信息。
    ...
    在 `application.yml` 文件中需要这里的 URL 信息。
