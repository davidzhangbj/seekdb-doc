...
**AI 模型管理服务是 AI 函数调用服务的基础**。在 seekdb 中，只有在成功注册并管理好 AI 模型及其端点之后，才能在 SQL 层调用各类 AI 函数（如 AI_COMPLETE、AI_EMBED、AI_RERANK 等），实现数据库内置的文本生成、向量嵌入、检索重排序等智能处理能力。详细的 AI 函数调用及其用法请参见 [AI 函数概述](../800.ai-function/0.ai-function-overview.md)。
