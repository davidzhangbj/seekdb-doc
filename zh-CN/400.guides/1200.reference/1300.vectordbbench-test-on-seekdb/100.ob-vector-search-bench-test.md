...
<main id="notice" type='notice'>
  <h4>注意</h4>
  <p>建议将 VectorDBBench 和 seekdb 部署在不同机器上，以避免 CPU 资源争夺，提高测试结果的可靠性。</p>
</main>
...
vectordbbench oceanbasehnsw --host $host --port $port --user $user --database test --m 16 --ef-construction 200 --ef-search 40 --k 10 --case-type Performance1536D50K --index-type HNSW
```
