...
seekdb 默认的字符序是 `utf8mb4_general_ci`。

seekdb 目前支持的字符序如下表所示。
...
| gb2312_chinese_ci   | gb2312       | 使用 GB2312 字符集，按照中文排序规则进行不区分大小写的排序。seekdb 支持该字符序。|
| gb2312_bin          | gb2312       | 使用 GB2312 字符集，按照二进制顺序进行区分大小写的排序。seekdb 支持该字符序。|
| ujis_japanese_ci    | ujis         | 使用 UJIS 字符集，按照日语排序规则进行不区分大小写的排序。seekdb 支持该字符序。|
| ujis_bin            | ujis         | 使用 UJIS 字符集，按照二进制顺序进行区分大小写的排序。seekdb 支持该字符序。|
| euckr_korean_ci     | euckr        | 使用 EUCKR 字符集，按照韩语排序规则进行不区分大小写的排序。seekdb 支持该字符序。|
| euckr_bin           | euckr        | 使用 EUCKR 字符集，按照二进制顺序进行区分大小写的排序。seekdb 支持该字符序。|
| eucjpms_japanese_ci | eucjpms      | 使用 EUCJPMS 字符集，按照日语排序规则进行不区分大小写的排序。seekdb 支持该字符序。|
| eucjpms_bin         | eucjpms      | 使用 EUCJPMS 字符集，按照二进制顺序进行区分大小写的排序。seekdb 支持该字符序。|
| cp932_japanese_ci   | cp932        | 使用 CP932 字符集，按照日语排序规则进行不区分大小写的排序。seekdb 支持该字符序。|
| cp932_bin           | cp932        | 使用 CP932 字符集，按照二进制顺序进行区分大小写的排序。seekdb 支持该字符序。|
| cp850_general_ci    | cp850        | 使用 CP850 字符集，按照通用排序规则进行不区分大小写的排序。seekdb 支持该字符序。|
| cp850_bin           | cp850        | 使用 CP850 字符集，按照二进制顺序进行区分大小写的排序。seekdb 支持该字符序。|
| hp8_english_ci      | hp8          | 使用 HP8 字符集，按照英语排序规则进行不区分大小写的排序。seekdb 支持该字符序。|
| hp8_bin             | hp8          | 使用 HP8 字符集，按照二进制顺序进行区分大小写的排序。seekdb 支持该字符序。|
| macroman_general_ci | macroman     | 使用 MacRoman 字符集，按照通用排序规则进行不区分大小写的排序。seekdb 支持该字符序。|
| macroman_bin        | macroman     | 使用 MacRoman 字符集，按照二进制顺序进行区分大小写的排序。seekdb 支持该字符序。|
| swe7_swedish_ci     | swe7         | 使用 SWE7 字符集，按照瑞典语排序规则进行不区分大小写的排序。seekdb 支持该字符序。|
| swe7_bin            | swe7         | 使用 SWE7 字符集，按照二进制顺序进行区分大小写的排序。seekdb 支持该字符序。|
