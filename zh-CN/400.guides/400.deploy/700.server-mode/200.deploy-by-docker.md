...
:::info
  ...
  <li>
  上述命令默认拉取最新版本，可根据实际需求在 <a href="https://hub.docker.com/r/oceanbase/seekdb">dockerhub</a>、<a href="https://quay.io/repository/oceanbase/seekdb">quay.io</a> 或 <a href="https://ghcr.io/oceanbase/seekdb">ghcr.io</a>中选择版本。
  </li>
  </ul>
:::
