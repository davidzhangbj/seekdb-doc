...
<Tabs>
  <TabItem value="Windows 操作系统" label="Windows 操作系统" default>
    ...
    * 检查磁盘
    ...
    1. 安装依赖
        ...
        2. 开启主板虚拟化
            ...
            4. 进入对应设置页面后，将 **Virtualization Technology** 后的按钮调到 **on**。
    ...
    2. 安装 OceanBase Desktop
        ...
        1. 下载安装包
            ...
            访问 [OceanBase seekdb 软件下载中心](https://www.oceanbase.ai/zh-CN/download)，找到 **OceanBase Desktop**，选择需要下载的版本、操作系统、CPU 架构，再单击 **下载** 即可下载。
  ...
  <TabItem value="MacOS 操作系统" label="MacOS 操作系统">
