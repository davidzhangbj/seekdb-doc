...
<Tabs>
  <TabItem value="CentOS/RHEL 系统" label="CentOS/RHEL 系统" default>
    ...
    * 您使用的用户已具有执行 sudo 命令的权限。
    ...
    1. 访问 [OceanBase seekdb 软件下载中心](https://www.oceanbase.ai/zh-CN/download)，找到 **OceanBase seekdb**，选择需要下载的版本、操作系统、CPU 架构，再单击 **下载** 即可下载，或者单机 **复制链接**，直接在服务器上使用 `wget` 命令下载。
  ...
  <TabItem value="Debian/Ubuntu 系统" label="Debian/Ubuntu 系统">
    ...
    * 您使用的用户已具有执行 sudo 命令的权限。
    ...
    3. 访问 [OceanBase seekdb 软件下载中心](https://www.oceanbase.ai/zh-CN/download)，找到 **OceanBase seekdb**，选择需要下载的版本、操作系统、CPU 架构，再单击 **下载** 即可下载，或者单机 **复制链接**，直接在服务器上使用 `wget` 命令下载。

    4. 在安装包所在目录下，执行 dpkg 命令安装 seekdb。
