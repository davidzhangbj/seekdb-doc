...
- [GV$SQL_WORKAREA（SYS 租户）](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002014856)
- [GV$SQL_WORKAREA（MySQL 租户）](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002015098)
- [GV$SQL_WORKAREA（Oracle 租户）](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002014080)
...
- [GV$SQL_PLAN_MONITOR（SYS 租户）](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002014866)
- [GV$SQL_PLAN_MONITOR（MySQL 租户）](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002015104)
- [GV$SQL_PLAN_MONITOR（Oracle 租户）](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002014140)
...
- [GV$OB_SQL_AUDIT（SYS 租户）](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002014911)
- [GV$OB_SQL_AUDIT（MySQL 租户）](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002015112)
- [GV$OB_SQL_AUDIT（Oracle 租户）](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002014073)
- [SQL Audit](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002013517)，了解该视图的具体使用方法
