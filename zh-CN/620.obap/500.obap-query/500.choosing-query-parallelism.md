...
详细原理请参见：[分布式计划的生成](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002013754)。
...
您可以手动设置并行度，详情参见[设置并行执行并行度](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002016197)。
...
有关 Auto DOP 的更多信息，参见 [Auto DOP](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002013753)。
...
更多信息，您可以参见[并行查询的执行](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002013756)。
