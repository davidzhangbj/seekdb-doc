...
<main id="notice" type='notice'>
    <h4>注意</h4>
    <p><ul><li>通义千问 LLM 提供了一定的免费使用额度。使用过程中请关注免费额度使用情况，超出将会产生费用。</li><li>本教程以通义千问 LLM 为例来介绍问答机器人的搭建，您也可以选择使用其他 LLM 进行搭建，选用其他 LLM 需要更新 <code>src-tauri/config.example.json</code> 文件中的 <code>apiKey</code>、<code>model</code> 和 <code>baseUrl</code> 参数。</li></ul></p>
</main>
...
推荐使用 OceanBase 的文档进行测试，[点击这里](https://github.com/oceanbase/oceanbase-doc)。
