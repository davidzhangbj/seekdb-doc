...
本文通过 SeekDB 的多模融合技术构建您的 SeekDB 文旅小助手。

## 概念介绍

:::collapse

* 多模融合：多模融合是 SeekDB 一体化产品理念的一个重要方向。本文的多模融合主要指的是多模数据混合检索技术。SeekDB 支持向量数据、空间数据、文档数据、标量数据等类型融合查询，基于向量索引、空间索引、全文索引等多种索引的支持，提供更高性能的混合检索能力。
...
* 您已部署 SeekDB。更多有关部署 SeekDB 集群的信息，请参见 [准备服务器](../../400.deploy/100.prepare-servers.md)。
