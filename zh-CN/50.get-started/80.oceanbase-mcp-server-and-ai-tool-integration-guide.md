...
| `get_current_time`          | 返回 SeekDB 集群的当前时间。|
| `search_oceanbase_document` | 搜索 SeekDB 官方文档（实验性功能）。|
...
| `ob_memory_query`           | 通过语义搜索检索 AI 记忆系统中的历史对话记录。（AI 记忆系统工具）|
...
* 您已完成部署 SeekDB。
  ...
  * 有关部署 SeekDB 的信息，参见 [部署概述](../400.deploy/100.deploy-overview.md)。
