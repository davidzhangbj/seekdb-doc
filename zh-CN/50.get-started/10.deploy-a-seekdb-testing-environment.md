...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <p>关于 SeekDB 更详细和更全面的部署方式，参见 <a href="../400.deploy/50.deploy-overview.md">部署 SeekDB</a>。</p>
</main>
...
如果您的环境中已安装 Docker 并启动 Docker 服务，也可以使用 Docker 容器部署 SeekDB。有关 docker 部署的详细信息，请参考 [部署 SeekDB 容器环境](../400.deploy/700.deploy-by-docker.md)。
