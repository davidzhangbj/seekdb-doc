...
本文以嵌入式部署和在客户端中使用为例介绍如何快速部署 SeekDB。

<main id="notice" type='explain'>
  <h4>说明</h4>
  <p>关于 SeekDB 更详细和更全面的部署方式，参见 <a href="../400.deploy/100.prepare-servers.md">准备服务器</a>。</p>
</main>
...
* 系统架构：x86_64，aarch64
* 在部署时提示 pip 版本过低，请先升级 pip 后再安装：

  ```bash
  pip install --upgrade pip
  ```

### 使用 python SDK 部署（最推荐）
