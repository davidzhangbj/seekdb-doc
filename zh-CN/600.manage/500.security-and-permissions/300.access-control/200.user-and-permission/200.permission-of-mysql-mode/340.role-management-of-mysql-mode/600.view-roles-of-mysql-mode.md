...
有关视图 `mysql.default_roles` 各字段的详细说明，请参见 [mysql.default_roles](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002015228)。
...
有关视图 `mysql.role_edges` 各字段的详细说明，请参见 [mysql.role_edges](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002015355)。
...
有关视图 `role_table_grants` 各字段的详细说明，请参见 [information_schema.role_table_grants](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002015321)。
...
有关视图 `role_column_grants` 各字段的详细说明，请参见 [information_schema.role_column_grants](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002015214)。
...
有关视图 `role_routine_grants` 各字段的详细说明，请参见 [information_schema.role_routine_grants](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002015340)。
