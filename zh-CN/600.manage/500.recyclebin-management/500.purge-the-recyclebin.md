...
有关集群级配置项 `recyclebin_object_expire_time` 的更多信息，请参见 [recyclebin_object_expire_time](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002015769)。
