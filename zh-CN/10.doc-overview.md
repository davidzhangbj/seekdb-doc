...
<DocsCards>
  <DocsCard header="使用嵌入式 seekdb" href="../../100.get-started/50.embedded-mode/25.using-seekdb-in-python-sdk.md">
    <p>以轻量级库的形式嵌入您的应用，支持 pip 一键安装。适用于个人学习、快速原型开发，并可高效运行于多种端侧设备。</p>
  </DocsCard>

<DocsCard header="使用服务器模式 seekdb" href="../../100.get-started/50.embedded-mode/25.using-seekdb-in-python-sdk.md">
