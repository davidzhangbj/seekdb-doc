...
* 确保你已拥有 [AI 函数服务](../../200.develop/700.ai-function/200.ai-function.md)相关权限。每个示例前都会提供完整的模型和端点注册信息，您可以直接复制使用。
...
* 通过视图查看和监控 AI 模型信息及调用情况在 [AI 函数服务使用及示例-AI 模型调用监控](../../200.develop/700.ai-function/200.ai-function.md)小节
* 了解 [向量搜索](../../200.develop/600.search/100.vector-search/100.vector-search-overview/100.vector-search-intro.md)
