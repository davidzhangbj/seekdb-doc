...
* 文件到数据库的离线迁移
  ...
  * 关于 DataX 的详细介绍，参见 [DataX 使用文档](https://github.com/alibaba/DataX)。
  * 关于 LOAD DATA LOCAL 的使用方法，参见 [LOAD DATA（Oracle 模式）](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002017398)和 [LOAD DATA（MySQL 模式）](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002017012)。
...
* 分区交换
  ...
  更多信息，参考 [分区交换（MySQL 模式）](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002015460) 和 [分区交换（Oracle 模式）](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002015390)文档。
...
* 历史数据
  ...
  使用 DataX 将历史数据导出为 CSV 文件后，再用 DataX 将 CSV 文件导入 OceanBase 数据库。
