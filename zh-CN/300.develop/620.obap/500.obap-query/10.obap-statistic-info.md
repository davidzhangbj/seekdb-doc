...
+ 统计信息包含表统计信息（Table Level Statistics）和列统计信息（Column Level Statistics）两种类型，更多关于统计信息类型的介绍，参见 [统计信息概述](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002016223)。

+ OceanBase 数据库优化器支持手动收集统计信息和自动收集统计信息，有关统计信息收集的详细介绍和操作指导，参见 [统计信息收集方式概述](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002017251)。

+ 关于统计信息管理的详细操作指导，参见 [统计信息管理](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002016223) 章节。

+ 通过一个简单的示例了解统计信息的使用，[查看示例](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002016224)。
