...
* **增量刷新（Incremental Refresh）**：又称快速刷新（Fast Refresh），只刷新增量变更的数据，对于大规模数据集尤其适用。增量刷新需要依赖于物化视图日志（Materialized View Log，Mlog），对查询语句有一定的要求，目前支持单表聚合、多表连接以及多表连接聚合的查询语句，且对聚合函数和连接方式有一些要求，详见：[MySQL 模式下刷新物化视图](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002016850) 和 [Oracle 模式下刷新物化视图](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002016843)。适用于延时要求高、数据量庞大且变更频繁的业务场景。
...
更多关于创建实时物化视图的详细信息，参见 [MySQL 模式下创建物化视图](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002016846) 和 [Oracle 模式下创建物化视图](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002016839)。
...
更多关于创建嵌套物化视图的详细信息，参见 [MySQL 模式下创建物化视图](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002016846) 和 [Oracle 模式下创建物化视图](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002016839)。
...
更多关于物化视图查询改写的详细信息，参见 [MySQL 模式下物化视图查询改写](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002016845) 和 [Oracle 模式下物化视图查询改写](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002016840)。
...
更多关于物化视图日志的详细信息，参见 [MySQL 模式下物化视图日志](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002016844) 和 [Oracle 模式下物化视图日志](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002016837)。
...
* 有关物化视图的详细介绍和使用指导，参见 [物化视图概述（MySQL 模式）](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002016847) 和 [物化视图概述（Oracle 模式）](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002016841)。
* 有关刷新物化视图的详细介绍和使用指导，参见 [刷新物化视图（MySQL 模式）](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002016850) 和 [刷新物化视图（Oracle 模式）](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002016843)。
* 有关删除物化视图日志的详细介绍和使用指导，参见 [物化视图日志（MySQL 模式）](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002016844) 和 [物化视图日志（Oracle 模式）](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002016837)。
* 有关删除物化视图的详细介绍和使用指导，参见 [删除物化视图（MySQL 模式）](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002016848) 和 [删除物化视图（Oracle 模式）](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002016842)。
