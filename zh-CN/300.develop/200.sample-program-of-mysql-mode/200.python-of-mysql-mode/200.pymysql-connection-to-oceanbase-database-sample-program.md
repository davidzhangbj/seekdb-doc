...
* `$host`：提供 OceanBase 数据库连接 IP。此处为是 OBServer 节点的 IP 地址。
...
* 更多创建数据库的信息，请参见 [CREATE DATABASE](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000001503334)。
