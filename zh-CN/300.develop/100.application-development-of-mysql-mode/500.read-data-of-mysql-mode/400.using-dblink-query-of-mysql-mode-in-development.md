...
* MySQL 模式下，支持通过 DBLink 访问的数据类型如下：
  ...
  * 其他类型：`ENUM`、`SET`。
  ...
  有关各数据类型的详细介绍及说明，请参见 [数据类型概述](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002017567)。

## 前提条件

已创建 DBLink。有关创建 DBLink 的详细信息，请参见 [创建 DBLink](../../../650.reference/300.database-object-management/100.manage-object-of-mysql-mode/900.manage-dblink-of-mysql-mode/100.create-a-dblink-of-mysql-mode.md)。
...
* 更多数据类型的介绍信息，请参见 [数据类型概述](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002017567)。

* 更多创建 DBLink 的信息，请参见 [创建 DBLink](../../../650.reference/300.database-object-management/100.manage-object-of-mysql-mode/900.manage-dblink-of-mysql-mode/100.create-a-dblink-of-mysql-mode.md)。

* 更多使用 DBLink 的信息，请参见 [通过 DBLink 访问远端数据库中的数据](../../../650.reference/300.database-object-management/100.manage-object-of-mysql-mode/900.manage-dblink-of-mysql-mode/300.access-a-remote-database-by-ablink-of-mysql-mode.md)。

* 更多使用 `SELECT` 的信息，请参见 [SELECT 语句](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002017573)。
