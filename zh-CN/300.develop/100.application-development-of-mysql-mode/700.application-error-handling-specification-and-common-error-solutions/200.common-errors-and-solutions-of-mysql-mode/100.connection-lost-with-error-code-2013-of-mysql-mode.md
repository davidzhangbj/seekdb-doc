...
* `wait_timeout` 参数的详细信息，请参见 [wait_timeout](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000001502575)。

* `interactive_timeout` 参数的详细信息，请参见 [interactive_timeout](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000001502511)。
