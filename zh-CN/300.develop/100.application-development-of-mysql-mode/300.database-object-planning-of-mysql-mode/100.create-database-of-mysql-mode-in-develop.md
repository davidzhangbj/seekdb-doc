...
* 避免使用保留关键字作为数据库名。
    ...
    有关 OceanBase 数据库 MySQL 模式的保留关键字的详细信息，请参见 [预留关键字](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002013011)。
...
* 可以通过使用反引号 (\`) 包围的方式来创建以纯数字命名的数据库名，但这种做法并不推荐，因为纯数字命名无较明显意义，且查询使用都需要加反引号 (\`)，这也将导致在使用时出现不必要的复杂性，易引起混淆。
  ...
  数据库支持的字符集编码相关内容请参见 [数据库级字符集](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002017547)。

## 使用命令行创建数据库

请使用 [CREATE DATABASE](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000001503334) 语句创建数据库。
...
* 更多有关查看数据库的信息，请参见 [查看数据库](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002015422)。
* 更多有关修改数据库的详细信息，请参见 [修改数据库](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002015420)。
* 更多有关删除数据库的详细信息，请参见 [删除数据库](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002015423)。
