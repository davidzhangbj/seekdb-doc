...
* `$user_name`：提供租户的连接账户。格式：`用户名@租户名`。
* `$password`：提供账户密码。
* `$sql_file`：SQL 脚本文件名称。
...
* 更多有关删除表的信息，请参见 [删除表](../../../650.reference/300.database-object-management/100.manage-object-of-mysql-mode/200.manage-tables-of-mysql-mode/800.delete-a-table-of-mysql-mode.md)。
