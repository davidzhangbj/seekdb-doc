...
* 直接删除索引，该索引不会进入回收站。删除表时，表上的索引会随主表一起进入回收站。删除租户时，有强制和非强制两种方式，具体请参见 [DROP TENANT](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002015472)。
