...
5. 创建安全策略。
   ...
   关于创建标签安全策略的详细信息，参见 [SA_SYSDBA.CREATE_POLICY](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002016702)。
...
6. 创建级别 Level 并指定其短名称和长名称。
   ...
   关于创建级别的详细信息，参见 [SA_COMPONENTS.CREATE_LEVEL](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002016693)。
...
7. 创建数据标签 Label 并查看结果。
   ...
   关于创建数据标签的详细信息，参见 [SA_LABEL_ADMIN.CREATE_LABEL](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002016701)。
...
8. 指定用户的 Label。
   ...
   2. 以安全管理员 `LBACSYS` 登录，为用户 `user1` 指定 Label。
      ...
      关于为用户指定标签的详细信息，参见 [SA_USER_ADMIN.SET_LEVELS](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002016696)。
...
9. 应用策略到表上。
   ...
   2. 以安全管理员 `LBACSYS` 登录，将策略 `MY_POLICY` 应用到表 `tbl1` 上。
      ...
      关于将指定的策略添加到表中的详细信息，参见 [SA_POLICY_ADMIN.APPLY_TABLE_POLICY](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002016685)。
...
10. 插入数据，验证查询结果。
   ...
   2. 在 `user1` 用户下设置 `SESSION LABEL` 和 `ROW LABEL`。
      ...
      关于设置当前数据库会话标签的详细信息，参见 [SA_SESSION.SET_LABEL](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002016691)。

      关于设置当前数据库会话默认行标签值的详细信息，参见 [SA_SESSION.SET_ROW_LABEL](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002016688)。
