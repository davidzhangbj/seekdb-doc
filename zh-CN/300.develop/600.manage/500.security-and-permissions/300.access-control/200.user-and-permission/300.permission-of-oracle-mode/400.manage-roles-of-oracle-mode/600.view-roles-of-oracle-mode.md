...
* 查看当前系统中的角色
  ...
  更多 `DBA_ROLES` 视图的字段及说明请参见 [DBA_ROLES](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002014430)。
...
* 查看角色中包含的角色
  ...
  更多 `ROLE_ROLE_PRIVS` 视图的字段及说明请参见 [ROLE_ROLE_PRIVS](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002014417)。
...
* 查看角色所拥有的系统权限。
  ...
  更多 `ROLE_SYS_PRIVS` 视图的字段及说明请参见 [ROLE_SYS_PRIVS](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002014390)。
...
* 查看角色所拥有的对象权限。
  ...
  更多 `ROLE_TAB_PRIVS` 视图的字段及说明请参见 [ROLE_TAB_PRIVS](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002014388)。
