...
2. 执行以下命令，查看某个用户被授予的权限。
   ...
   * 查看某个用户被授予的系统权限
     ...
     更多 `DBA_SYS_PRIVS` 视图的字段及说明请参见 [DBA_SYS_PRIVS](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002014386)。
   ...
   * 查看当前用户被授予的系统权限
     ...
     更多 `USER_SYS_PRIVS` 视图的字段及说明请参见 [USER_SYS_PRIVS](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002014311)。
   ...
   * 查看某个用户被授予的对象权限
     ...
     更多 `DBA_TAB_PRIVS` 视图的字段及说明，参见 [DBA_TAB_PRIVS](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002014421)。
   ...
   * 查看当前用户被授予的对象权限
     ...
     更多 `USER_TAB_PRIVS` 视图的字段及说明请参见 [USER_TAB_PRIVS](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002014434)。
   ...
   * 查看某个用户所拥有的角色。
     ...
     更多 `DBA_ROLE_PRIVS` 视图的字段及说明请参见 [DBA_ROLE_PRIVS](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002014433)。
   ...
   * 查看当前用户被授予的角色
     ...
     更多 `USER_ROLE_PRIVS` 视图的字段及说明，参见 [USER_ROLE_PRIVS](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002014499)。
