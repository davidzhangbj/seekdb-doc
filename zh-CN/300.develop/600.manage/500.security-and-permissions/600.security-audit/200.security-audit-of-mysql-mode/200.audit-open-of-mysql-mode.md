...
通过 [AUDIT_LOG_FILTER_SET_FILTER](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002142554) 函数（表达式）创建过滤器，命令如下：
...
通过 [mysql.audit_log_filter](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002142556) 视图查看审计过滤器的定义。
...
通过 [AUDIT_LOG_FILTER_SET_USER](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002142555) 函数（表达式）将过滤器设置到用户上。
...
通过 [mysql.audit_log_user](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002142557) 视图查看审计过滤器和用户的映射关系。。
...
通过配置项 [audit_log_enable](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002142560) 开启 MySQL 租户下的审计功能。
