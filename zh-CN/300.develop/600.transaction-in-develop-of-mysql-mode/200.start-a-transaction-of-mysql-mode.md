...
视图 `oceanbase.V$OB_TRANSACTION_PARTICIPANTS` 中的字段及详细说明请参见 [oceanbase.V$OB_TRANSACTION_PARTICIPANTS](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002015149)。
