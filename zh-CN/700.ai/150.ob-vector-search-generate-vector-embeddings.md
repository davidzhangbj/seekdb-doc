...
OceanBase 数据库 V4.4.1 版本开始支持使用 AI 函数服务生成向量嵌入。用户无需安装任何依赖，只需注册好模型信息，即可在 OceanBase 数据库中使用 AI 函数服务生成向量嵌入。详情请参见 [AI 函数服务使用及示例](700.ob-vector-search-reference/300.ob-vector-search-ai-function/300.ob-vector-search-ai-function.md)。
