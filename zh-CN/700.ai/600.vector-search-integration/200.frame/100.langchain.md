...
本教程结合通义千问 API 演示如何将 SeekDB 中的 [向量检索功能](../100.vector-search/100.vector-search-overview/100.vector-search-intro.md)、[通义千问](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000001579715) 与 [LangChain](https://python.langchain.com/) 集成实现文档问答。
